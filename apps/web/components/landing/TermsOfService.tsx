...
const TermsOfService: React.FC<TermsProps> = ({ onNavigate, isTelegramApp }) => {
  return (
    <div className="bg-white dark:bg-gray-900 py-16 lg:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in-up">
        {!isTelegramApp && (
          <button onClick={onNavigate} className="text-sm font-bold text-[#0a4848] dark:text-teal-400 hover:underline mb-8">
              &larr; Back to Home
          </button>
        )}
